...
公開 Notebook 與資料 URL 固定到 tag `v1.0.0-rc.1`，返回入口固定為 `https://johnnychao.github.io/stats-quest-2026/rc/v1.0.0-rc.1/`，瀏覽器進度鍵為 `statsquest2026:rc:v1.0.0-rc.1`。遠端 tag 尚未建立前，連結預期無法開啟。
